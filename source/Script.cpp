...
STDMETHODIMP_(MoaError) GetSymbols_TStdXtra(TStdXtra* This) {
	...
	PIMoaMmValue p = This->mmValueInterfacePointer;
	auto &s = This->symbols;

	ThrowErr(p->StringToSymbol("AgentOptions", &s.AgentOptions));
	ThrowErr(p->StringToSymbol("AgentPropList", &s.AgentPropList));
	ThrowErr(p->StringToSymbol("AlternatePathExtension", &s.AlternatePathExtension));
	ThrowErr(p->StringToSymbol("Basename", &s.Basename));
	ThrowErr(p->StringToSymbol("Bitmap", &s.Bitmap));
	ThrowErr(p->StringToSymbol("Composite", &s.Composite));
	ThrowErr(p->StringToSymbol("Current", &s.Current));
	ThrowErr(p->StringToSymbol("DefaultAgent", &s.DefaultAgent));
	ThrowErr(p->StringToSymbol("DefaultLabel", &s.DefaultLabel));
	ThrowErr(p->StringToSymbol("DefaultOptions", &s.DefaultOptions));
	ThrowErr(p->StringToSymbol("DefaultPath", &s.DefaultPath));
	ThrowErr(p->StringToSymbol("Dirname", &s.Dirname));
	ThrowErr(p->StringToSymbol("DisplayName", &s.DisplayName));
	ThrowErr(p->StringToSymbol("Documents", &s.Documents));
	ThrowErr(p->StringToSymbol("Empty", &s.Empty));
	ThrowErr(p->StringToSymbol("Extension", &s.Extension));
	ThrowErr(p->StringToSymbol("Filename", &s.Filename));
	ThrowErr(p->StringToSymbol("IconPropList", &s.IconPropList));
	ThrowErr(p->StringToSymbol("Image", &s.Image));
	ThrowErr(p->StringToSymbol("IncrementFilename", &s.IncrementFilename));
	ThrowErr(p->StringToSymbol("LabelList", &s.LabelList));
	ThrowErr(p->StringToSymbol("Lingo", &s.Lingo));
	ThrowErr(p->StringToSymbol("Loaded", &s.Loaded));
	ThrowErr(p->StringToSymbol("Location", &s.Location));
	ThrowErr(p->StringToSymbol("MixerSaved", &s.MixerSaved));
	ThrowErr(p->StringToSymbol("Music", &s.Music));
	ThrowErr(p->StringToSymbol("Name", &s.Name));
	ThrowErr(p->StringToSymbol("NewFolder", &s.NewFolder));
	ThrowErr(p->StringToSymbol("Picture", &s.Picture));
	ThrowErr(p->StringToSymbol("Pictures", &s.Pictures));
	ThrowErr(p->StringToSymbol("ReplaceExistingFile", &s.ReplaceExistingFile));
	ThrowErr(p->StringToSymbol("SampleSize", &s.SampleSize));
	ThrowErr(p->StringToSymbol("Script", &s.Script));
	ThrowErr(p->StringToSymbol("ScriptSyntax", &s.ScriptSyntax));
	ThrowErr(p->StringToSymbol("ScriptText", &s.ScriptText));
	ThrowErr(p->StringToSymbol("Sound", &s.Sound));
	ThrowErr(p->StringToSymbol("Type", &s.Type));
	ThrowErr(p->StringToSymbol("TypePropList", &s.TypePropList));
	ThrowErr(p->StringToSymbol("Videos", &s.Videos));
	ThrowErr(p->StringToSymbol("WriterClassID", &s.WriterClassID));
	ThrowErr(p->StringToSymbol("XtraMedia", &s.XtraMedia));
