...
namespace Path {
	...
	MoaError Info::makePathNameInterfacePointer() {
	...
	std::string& Info::trimExtension(std::string &extension) {
	...
	MoaError Info::incrementFilename() {
	...
	bool Info::getDirnameOrEmpty(std::string &dirname) {
		std::optional<std::string> dirnameOptional = std::nullopt;
	...
	bool Info::getBasenameOrEmpty(std::string &basename) {
	...
	bool Info::getExtensionOrEmpty(std::string &extension, bool fromBasename) {
	...
	bool Info::getFilenameOrEmpty(std::string &filename) {
		std::optional<std::string> filenameOptional = std::nullopt;
